...
--
-- Quy tắc bắt buộc dự án: docs/SYSTEM_DEVELOPMENT_RULES.md §32.1
-- Cursor: .cursor/rules/tlkv-supabase-data-api-grants.mdc
--
...
--
-- Bảng mới: GRANT phải nằm trong cùng migration tạo bảng — không chỉ
-- dựa vào file này sau. File này dùng để đồng bộ / chạy lại an toàn.
--
-- Chạy trong Supabase → SQL Editor sau khi đã tạo bảng.
